...
public sealed class CreateBackupCommandHandler : ICommandHandler<CreateBackupRequestCommand, BackupFileParameters>
{
    ...
    public async Task<Result<BackupFileParameters>> Handle(CreateBackupRequestCommand request,
        CancellationToken cancellationToken)
    {
        ...
        Result<BaseBackupParameters> baseBackupRestoreParametersResult =
        ...
        if (baseBackupRestoreParametersResult.IsFailure)
        {
            return new ValidationError([
                .. baseBackupRestoreParametersResult.Error.ToErrorArray(),
        ...
        var sourceBaseBackupCreator = new BaseBackupRestoreTool(_logger, baseBackupRestoreParametersResult.Value);
        ...
        {
            return DatabaseApiClientErrors.BackupFileParametersIsNull;
        }
